...
int main() {
    ...
    std::cout << "Sequential Merge Sort Time: " << timeSeqMerge << " milliseconds" << std::endl;
    std::cout << "Parallel Merge Sort Time: " << timeParMerge << " milliseconds" << std::endl;

    return 0;
}

/* g++ mergeomp.cpp -lgomp -o mergeomp 
    ./mergeomp                        */
